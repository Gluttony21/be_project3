...
$query = mysqli_query($koneksi,"SELECT * FROM tbl_tiket JOIN tbl_karyawan ON tbl_tiket.user = tbl_karyawan.id_karyawan JOIN tbl_divisi ON tbl_karyawan.divisi = tbl_divisi.id_divisi JOIN tbl_status ON tbl_tiket.status = tbl_status.id_sts");
$respons = [];
